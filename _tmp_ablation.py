"""N149 ablation: test each component on Driving 8hz."""
import subprocess, os
import pandas as pd

PY = r"D:/software/Anaconda_envs/envs/myEVS/python.exe"
CLEAN = r"D:/hjx_workspace/scientific_reserach/dataset/DND21/mydriving_ED24/driving_noise_8hz_ed24_withlabel/driving_noise_8hz_signal_only.npy"
NOISY = r"D:/hjx_workspace/scientific_reserach/dataset/DND21/mydriving_ED24/driving_noise_8hz_ed24_withlabel/driving_noise_8hz_labeled.npy"
...
for name, env_vars in ablations:
    env = os.environ.copy()
    env.update(env_vars)
    out = f"data/_abl_{name.replace(' ','_')}.csv"
