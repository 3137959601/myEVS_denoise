...
def _require_numba() -> None:
    if numba is None:
        raise RuntimeError("n140 requires numba, but import failed")


def _try_build_n140_kernel():
    _require_numba()
...
def score_stream_n140(
    ...
    *,
    ...
    """N140 (7.86): n128-style backbone with Gaussian spatial decay."""
    ...
    sigma = float(_read_float_env("MYEVS_N140_SIGMA", 2.0))

    ker = _try_build_n140_kernel()
    ker(
