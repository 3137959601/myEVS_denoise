...
|---|---|:---:|---|:---:|---|:---:|---|:---:|---|:---:|---|:---:|---|:---:|---|:---:|---|:---:|---|:---:|---|:---:|
| 1hz | **v2.2** | **0.9512** | EBF | 0.9484 | YNoise | 0.9408 | N149 | 0.9381 | TS | 0.9298 |  STCF_orig | 0.9136	 |BAF | 0.9136	 | PFD | 0.9135 | MLPF | 0.8632 | EvFlow | 0.8486 | KNoise | 0.6359 |
...
| `TS` | 0.9102 | 0.9090 | 0.8977 | 0.9148 | (4,128ms) | (4,128ms) | (4,128ms) | (4,128ms) | heavy 边界修复(+0.033) |
...
| `PFD` | `cpp` | 0.9610 | — | (1, 128ms) | r=1 tau修正(+0.267), 仍低于r=3(0.986) |
| `MLPF` | `python` | 0.9938 | 0.9826 | (scene-wise) | 10场景逐场景重训+评测（2026-05-22） |
| `STCF_orig` | `cpp` | 0.9857 | — | (1, 64~256ms, k=1) | 10场景逐场景最优tau均值(+0.047) |
| `BAF` | `cpp` | 0.9494 | — | (1, 16~64ms) | 10场景逐场景最优tau均值(+0.002) |
...
| `PFD` | `cpp` | 0.8120 | — | (1, 8K, m=1) | r=1 fixed, (tau,m)最优重跑 |
...
**数据一致性验证规则**（写入此处防止遗忘）：
1. **BAF ≤ STCF_orig**：BAF 为最简单时空滤波器，不应超越更复杂的 STCF_orig。LED 修正后已满足（BAF=0.8375 < STCF_orig=0.8649）。唯一例外：DVSCLEAN (BAF=0.948 > STCF_orig=0.939)，因极低事件率下简单时间窗优于需 k 邻域的计数
